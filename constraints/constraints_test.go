...
import "github.com/nathan-joslin/exp/constraints"
...
func TestFailure(t *testing.T) {
	...
	// This package is github.com/nathan-joslin/exp/constraints, so the root of the x/exp
...
replace github.com/nathan-joslin/exp => %s
`, expModDir)
